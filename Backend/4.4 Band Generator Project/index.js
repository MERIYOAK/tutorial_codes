...
app.post("/submit", (req, res) => {
  ...
  const randomNumber1 = Math.floor(Math.random() * 1346);
  const randomNumber2 = Math.floor(Math.random() * 4307);

  const adjective = adj[randomNumber1];
  const noun1 = noun[randomNumber2];
